...
internal class GLibrary
{
    ...
    static GLibrary()
    {
        ...
        _libraryDefinitions[Library.GArrow] = new[] {"libarrow-glib.dll", "libarrow-glib.so", "libarrow-glib.dylib"};
        _libraryDefinitions[Library.GArrowDataset] = new[] {"libarrow-dataset-glib.dll", "libarrow-dataset-glib.so", "libarrow-dataset-glib.dylib"};
    }
